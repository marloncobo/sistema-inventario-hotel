...
class RestClientConfigTest {
    ...
    @Test
    void roomsRestClientForwardsAuthorizationHeader() {
    ...
    @Test
    void roomsRestClientFallsBackToForwardedAuthorizationHeader() {
        CapturingRequestFactory requestFactory = new CapturingRequestFactory();
    ...
    private RestClient restClient(CapturingRequestFactory requestFactory, HttpServletRequest request) {
        ...
        return new RestClientConfig().roomsRestClient(builder, "http://rooms-service:8082");
    }
