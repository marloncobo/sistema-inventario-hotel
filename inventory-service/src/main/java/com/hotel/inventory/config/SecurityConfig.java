    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/inventory/internal/items/decrease").hasAnyRole("ADMIN", "ALMACENISTA", "HOUSEKEEPING", "SERVICIO")
                        .requestMatchers(HttpMethod.GET, "/api/inventory/**").hasAnyRole("ADMIN", "ALMACENISTA", "SERVICIO")
