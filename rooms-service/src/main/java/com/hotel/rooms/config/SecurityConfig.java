    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/rooms/*/supplies/assign").hasAnyRole("ADMIN", "ALMACENISTA", "HOUSEKEEPING", "SERVICIO")
                        .requestMatchers(HttpMethod.GET, "/api/rooms/**").hasAnyRole("ADMIN", "ALMACENISTA", "RECEPCION", "HOUSEKEEPING", "SERVICIO")
