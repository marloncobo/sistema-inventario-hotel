    ...
    SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(exchanges -> exchanges
                        ...
                        .pathMatchers(HttpMethod.POST, "/inventory/api/inventory/internal/items/decrease").hasAnyRole("ADMIN", "ALMACENISTA", "HOUSEKEEPING", "SERVICIO")
                        ...
                        .pathMatchers(HttpMethod.POST, "/rooms/api/rooms/*/supplies/assign").hasAnyRole("ADMIN", "ALMACENISTA", "HOUSEKEEPING", "SERVICIO")
                        .pathMatchers(HttpMethod.GET, "/inventory/**").hasAnyRole("ADMIN", "ALMACENISTA", "SERVICIO")
                        .pathMatchers(HttpMethod.GET, "/rooms/**").hasAnyRole("ADMIN", "ALMACENISTA", "RECEPCION", "HOUSEKEEPING", "SERVICIO")
