...
public class SecurityConfig {
    ...
    SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http, CorsConfigurationSource corsConfigurationSource) {
        return http
                ...
                .authorizeExchange(exchanges -> exchanges
                        ...
                        .pathMatchers(HttpMethod.POST, "/ai/api/ai/inventory-assistant").hasAnyRole("ADMIN", "ALMACENISTA", "SERVICIO", "RECEPCION")
                        ...
                        .pathMatchers(HttpMethod.POST, "/rooms/api/rooms/*/supplies/assign").hasAnyRole("ADMIN", "SERVICIO")
    ...
    CorsConfigurationSource corsConfigurationSource(
            @Value("${security.cors.allowed-origin-patterns:http://localhost:*,https://localhost:*,http://127.0.0.1:*,https://127.0.0.1:*,https://*.run.app}") String allowedOriginPatterns
    ) {
